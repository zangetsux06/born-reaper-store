      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-red-900/30 border border-red-800/50 rounded-full mb-6">
            ...
            <span className="text-sm text-gray-300">Platform Top Up Terpercaya #1</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <a
              href="#topup"
              className="group px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded-xl text-white font-semibold transition-all duration-300 shadow-lg shadow-red-900/30 hover:shadow-red-900/50 hover:-translate-y-1"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              <div key={index} className="p-4 bg-white/5 backdrop-blur-sm border border-white/5 rounded-xl">
